...
parser.add_argument('rpkmdir') #rpkmdir stores ctg_rpkm files for each sample.
parser.add_argument('annotation') #annotation file is contig and species annotation


annotation = pd.read_csv(args.annotation,sep='\t',header=None)
annotation.columns = ['ctg','species']
ctg2sp = dict(zip(annotation['ctg'],annotation['species']))
